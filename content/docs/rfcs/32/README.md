...
| **Epoch**                 | An identifier that groups signals and can be thought of as a voting booth. Usually a timestamp or time interval in the RLN apps. |
...
enabling secret reveal if more than 1 unique signal is produced per epoch.
