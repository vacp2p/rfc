...
- The `topics` field MUST indicate the list of topics to query. The items in this list correspond to the `contentTopic` of the queried Waku messages (see [14/WAKU-MESSAGE](../14)).
