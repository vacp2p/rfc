...
In order to count for nodes asynchrony, and assuming that nodes may be out of sync for at most 20 seconds, the querying node SHOULD add an offset of 20 seconds to their offline time window. 
