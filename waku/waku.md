...
The status message MUST contain an associated list containing various options. All options within this list are OPTIONAL, ordering of the key-value pairs is not guaranteed and therefore MUST not be relied on.
